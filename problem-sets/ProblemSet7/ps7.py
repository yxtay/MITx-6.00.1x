...
class NewsStory(object):
    def __init__(self, guid, title, subject, summary, url):
        self.guid = guid
        self.title = title
...
class WordTrigger(Trigger):
    def __init__(self, word):
        self.triggerWord = word.lower()
        
    def isWordIn(self, text):
        # function to clean text and split by space
        ...
        return self.triggerWord in words
...
class NotTrigger(Trigger):
    def __init__(self, trigger):
        self.notTrigger = trigger
        
    def evaluate(self, story):
        return not self.notTrigger.evaluate(story)
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    """
    # TODO: Problem 11
    triggerTypeDict = {'TITLE': TitleTrigger,
    ...
    if triggerType in ['TITLE', 'SUBJECT', 'SUMMARY', 'PHRASE']:
        trigger = triggerTypeDict[triggerType](' '.join(params))
    elif triggerType in ['AND', 'OR']:
        trigger = triggerTypeDict[triggerType](triggerMap[params[0]], \
                    triggerMap[params[1]])
