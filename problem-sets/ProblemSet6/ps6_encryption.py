...
def buildCoder(shift):
    ...
    cipher = {}
    for i in range(26):
        cipher[string.ascii_lowercase[i]] = string.ascii_lowercase[(i+shift) % 26]
        cipher[string.ascii_uppercase[i]] = string.ascii_uppercase[(i+shift) % 26]
...
def findBestShift(wordList, text):
    ...
    for shift in range(26):
        ...
        wordCount = sum([isWord(wordList, word) for word in decrypted.split()])
